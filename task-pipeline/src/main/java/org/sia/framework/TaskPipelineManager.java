...
public class TaskPipelineManager {
     ...
     * 我们可以在如下场景中使用：</br>
     * 场景1：用户维度串行执行，则pipelineId选择为userId。</br>
     * 场景2：框架层面缓解Kafka消息积压问题，以kafka consumer 分派的partition数量进行并发度调整，则pipelineId选择为kafkaPartitionId</br>
     * 场景3：整合场景1 & 场景2，则pipelineId选择为partitionId + userId。</br>
     * 场景4：通过taskNamespace区分不同业务场景，达到框架在多个业务场景下复用的能力。</br>
     *
     * @param taskNamespace
     * @param pipelineId
     * @param task
